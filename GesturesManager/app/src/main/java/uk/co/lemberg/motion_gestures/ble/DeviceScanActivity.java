...
public class DeviceScanActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        validate.setText("connect to sensors");
        getListView().addFooterView(validate);

        Button dBluetooth = new Button(this);
        dBluetooth.setText("use phone's sensors instead");
        getListView().addFooterView(dBluetooth);
        ...
        dBluetooth.setOnClickListener(new Button.OnClickListener() { //Detect touch on button
            @Override
            public void onClick(View v) {
...
*/
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.main_gatt, menu);
        if (!mScanning) {
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public View getView(final int i, View view, ViewGroup viewGroup) {
            ...
            if(device != null) {
                ...
                View tv = view.findViewById(R.id.textviews);
                ...
                callbtn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        final Intent intent = new Intent(_context, DeviceControlActivity.class);
                        intent.putExtra(DeviceControlActivity.EXTRAS_DEVICE_NAME, device.getName());
                        intent.putExtra(DeviceControlActivity.EXTRAS_DEVICE_ADDRESS, device.getAddress());
                        if (mScanning) {
                            mBluetoothAdapter.stopLeScan(mLeScanCallback);
